...
export default function AppBar({onSignin,onSignout,userData,settings} : AppBarProps){
    return(
        <div className="flex flex-row justify-between px-10 py-[7px] shadow-lg bg-[#ECF5FC]">
            <div className="h-[40px] cursor-pointer" onClick={() => {window.location.href = 'http://localhost:3000/dashboard'}} >
                <Paytm></Paytm>
            </div>
            <div className="flex flex-row gap-8 items-center">
                {userData && <div className="hover:cursor-pointer hover:text-[#005EFF]" onClick={settings}>
                    {SettingsIcon()}
                </div>}
                {userData && <div className="hover:cursor-pointer hover:text-[#005EFF]">
                    {notificationIcon()}
                </div>}
                <div >
...
function Paytm(){
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="55" viewBox="0 10 180 50" fill="none">
